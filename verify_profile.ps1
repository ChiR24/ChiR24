...
if (Test-Path -Path "README.md") {
    ...
    if ($readmeContent -match "giphy.gif") {
        Write-Host "[OK] README contains animation link."
    } else {
...
Write-Host "2. Initialize Git in this folder:"
Write-Host "   git init"
Write-Host "   git add ."
Write-Host "   git commit -m 'Initial commit'"
Write-Host "3. Connect and push to GitHub:"
